...
const LOCALES = {
  ...
  untitled:'Untitled',
    ...
    file_revealed: (name) => `Revealed ${name} in your file manager`,
  ...
  ru: {
    ...
    file_revealed: (name) => `Файл ${name} открыт в файловом менеджере`,
  ...
  es: {
    ...
    file_revealed: (name) => `Se mostró ${name} en el gestor de archivos`,
  ...
  de: {
    ...
    file_revealed: (name) => `${name} im Dateimanager angezeigt`,
  ...
  zh: {
    ...
    file_revealed: (name) => `\u5df2\u5728\u6587\u4ef6\u7ba1\u7406\u5668\u4e2d\u5b9a\u4f4d ${name}`,
  ...
  'zh-Hant': {
    ...
    file_revealed: (name) => `\u5df2\u5728\u6a94\u6848\u7ba1\u7406\u5668\u4e2d\u5b9a\u4f4d ${name}`,
